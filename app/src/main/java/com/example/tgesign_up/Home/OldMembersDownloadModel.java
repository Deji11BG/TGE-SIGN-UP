...
public class OldMembersDownloadModel {
    ...
    @SerializedName("finished_checklist")
    private String finished_checklist;

    @SerializedName("last_sync_down_time_input_records")
    ...
    public void setLast_sync_down_time_input_records(String last_sync_down_time_input_records) {
