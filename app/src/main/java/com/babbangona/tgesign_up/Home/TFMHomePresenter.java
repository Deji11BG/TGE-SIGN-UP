...
import com.babbangona.tgesign_up.TFMRecyclers.TFMHomeRecycler.LeaderCardRecyclerInterface;
        ...
        if(charString.isEmpty()){
            ...
            for(prospectiveTGETable.prospectiveTGETableRecycler leaders : total_leader_list){
                ...
                if(
                        ...
                        leaders.getMember_id().toLowerCase().contains(charString.toLowerCase()) ||
